...
const selectItems = (state: RootState) => state.shopping.items;
const selectActiveFilter = (state: RootState) => state.shopping.activeFilter;
const selectSelectedCategory = (state: RootState) => state.shopping.selectedCategory;
const selectSearchTerm = (state: RootState) => state.shopping.searchTerm;

export const selectFilteredItems = createSelector(
  [selectItems, selectActiveFilter, selectSelectedCategory, selectSearchTerm],
  (items, activeFilter, selectedCategory, searchTerm) => {
